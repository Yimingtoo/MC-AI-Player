...
/**
 * MCP 协议处理器，与传输层解耦。
 * 接收 JSON-RPC 消息并处理，通过 responseSender 回调返回响应。
 * 可用于 stdio、SSE 或其他传输层。
 */
public class McpProtocolHandler {
    ...
    private final Consumer<JsonObject> responseSender;
    ...
    /**
     * @param responseSender 回调，每次需要发送 JSON-RPC 响应时调用
     */
    public McpProtocolHandler(
            Consumer<JsonObject> responseSender,
